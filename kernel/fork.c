	      ...
	      unsigned long tls)
{
	...
	if (task_is_zygote(current)) {
	   ...
	   */
	    ...
	    devfreq_boost_kick_max(DEVFREQ_MSM_LLCCBW, 75, true);
	    devfreq_boost_kick_max(DEVFREQ_MSM_CPUBW, 75, true);
	  } else if (kp_active_mode() == 2) {
	    cpu_input_boost_kick_max(10);
	    devfreq_boost_kick_max(DEVFREQ_MSM_LLCCBW, 15, true);
	    devfreq_boost_kick_max(DEVFREQ_MSM_CPUBW, 15, true);
      }
}
